...
class CarpentryService extends StatelessWidget {
  final Map<String, dynamic> indexs;

  CarpentryService({required this.indexs});
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 8),
            Text(
              'Experienced carpenter with over 10 years of expertise in residential and commercial carpentry. I am dedicated to solving issues efficiently and providing high-quality service to all clients.',
            ...
            Text('• Emergency Carpentry Repairs'),
            SizedBox(height: 16),
            Center(
