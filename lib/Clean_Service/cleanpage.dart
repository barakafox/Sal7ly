...
import 'package:sal7ly/Clean_Service/info_clean.dart';
import 'package:sal7ly/Conditioning_Service/info_condition.dart';



class CLeanListPage extends StatelessWidget {
  final List<Map<String, String>> cleans = [
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: GridView.builder(
          ...
          itemCount: cleans.length,
          itemBuilder: (context, index) {
            final clean = cleans[index];
            return Card(
              ...
              child: InkWell(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => CleanService(indexs: clean),
                    ),
                  );
                },
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      CircleAvatar(
                        backgroundImage: NetworkImage(clean['image']!),
                        radius: 40,
                      ),
                      SizedBox(height: 8),
                      Text(clean['name']!, style: TextStyle(fontWeight: FontWeight.bold)),
                      SizedBox(height: 4),
